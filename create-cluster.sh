...
# This commmand will not work for the C   az aks update -n udacity-cluster -g acdnd-c4-project --attach-acr acrkhaled123loud Lab users, because you are not allowed to create Log Analytics workspace for monitoring
az aks create \
